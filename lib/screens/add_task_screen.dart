...
void dispose() {
 ...
 _summit(){
   if (_formKey.currentState.validate()){
     ...
     print('$_title, $_date,$_time, $_priority');

     Task task = Task(title: _title, date: _date,time: _time, priority: _priority);
     if (widget.task == null) {
       task.status = 0;
                ...
                Form(
                     ...
                     Padding(
                      ...
                      child: DropdownButtonFormField(
                        ...
                        validator: (input) => _priorities == null
                          ? 'Please select a priority level' : null,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      child: TextButton(onPressed: _summit, 
